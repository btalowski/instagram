    ...
    <form action="/profile/<?php echo e($user->id); ?>" enctype="multipart/form-data" method="post">
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="row">
                    <label for="image" class="col-md-4 col-form-label">Zdjęcie profilowe</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Bartek\bartkoGram\resources\views/profiles/edit.blade.php ENDPATH**/ ?>